...
public class LoginWechatResponse {
	...
	public LoginWechatResponse() {
	}

	public LoginWechatResponse(User userInfo, boolean isCreated) {
		this.userInfo = userInfo;
		this.isCreated = isCreated;
	}
	...
	public boolean equals(Object obj) {
		...
		LoginWechatResponse other = (LoginWechatResponse) obj;
		return (
	...
	public void readFrom(TarsInputStream _is) {
		...
		this.isCreated = _is.read(isCreated, 1, false);
	}
